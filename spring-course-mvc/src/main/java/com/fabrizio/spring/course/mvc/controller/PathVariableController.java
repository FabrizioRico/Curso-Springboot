...
//	private String message;
	...
	private List<String> listOfValues3;
	...
	@GetMapping("/qux/{message}")
	public ParamDto qux(@PathVariable String message) {
	...
	@GetMapping("/bar/{product}/{id}")
	public Map<String, Object> bar(@PathVariable String product, @PathVariable long id){
	...
	public Map<String, Object> values(@Value("${config.message}") String message){
		Map<String, Object> json = new HashMap<>();
		Integer env = environment.getProperty("config.code", Integer.class);
		...
		json.put("listOfValues3", listOfValues3);
